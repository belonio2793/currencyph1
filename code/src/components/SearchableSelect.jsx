            ...
            {flatOptions.length === 0 ? (
              ...
              <>
                ...
                {filteredFiat.length > 0 && (
                  <>
                    <div className="sticky top-0 z-10 px-4 py-2 text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-2 bg-slate-100">
                ...
                {filteredCrypto.length > 0 && (
                  <>
                    <div className="sticky top-0 z-20 px-4 py-2 text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-2 bg-slate-100 border-t border-slate-200">
