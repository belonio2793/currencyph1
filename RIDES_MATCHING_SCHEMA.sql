...
-- Update ride_profiles to track ratings if not already present
ALTER TABLE ride_profiles ADD COLUMN IF NOT EXISTS average_rating DECIMAL(3, 2) DEFAULT 5.0;
ALTER TABLE ride_profiles ADD COLUMN IF NOT EXISTS rider_rating DECIMAL(3, 2) DEFAULT 5.0;
ALTER TABLE ride_profiles ADD COLUMN IF NOT EXISTS driver_rating DECIMAL(3, 2) DEFAULT 5.0;
ALTER TABLE ride_profiles ADD COLUMN IF NOT EXISTS total_rides_as_driver INTEGER DEFAULT 0;
ALTER TABLE ride_profiles ADD COLUMN IF NOT EXISTS total_rides_as_rider INTEGER DEFAULT 0;
ALTER TABLE ride_profiles ADD COLUMN IF NOT EXISTS total_earnings DECIMAL(12, 2) DEFAULT 0;
