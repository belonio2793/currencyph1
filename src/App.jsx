      ...
      <main>
        ...
        {showAuth ? (
          ...
          <>
            ...
            {activeTab === 'business-marketplace' && <BusinessMarketplace userId={userId} setActiveTab={setActiveTab} />}
            ...
            {activeTab === 'addresses' && <Addresses userId={userId} onClose={() => setActiveTab('home')} />}
      ...
      <footer className="bg-white border-t border-slate-100 mt-20">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div>
              <h4 className="text-sm font-semibold text-slate-900 mb-4 uppercase tracking-wider">Industry</h4>
              <ul className="space-y-3 text-sm">
                <li><button onClick={() => setActiveTab('business-marketplace')} className="text-slate-600 hover:text-slate-900 transition-colors">Marketplace</button></li>
              </ul>
            </div>
            <div>
