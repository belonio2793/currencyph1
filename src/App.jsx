...
import { checkAndRefreshRatesIfNeeded } from './lib/ratesFetchService'
...
const PartnershipHero = lazy(() => import('./components/PartnershipHero'))
            ...
            <div className="min-h-screen bg-slate-50 flex">
              ...
              <div className="flex-1 flex flex-col">
                <div data-component="navbar">
                  ...
                  fiatHoldingsConverted={fiatHoldingsConverted}
                  cryptoHoldingsConverted={cryptoHoldingsConverted}
                  onShowAuth={(tab) => {
                    setAuthInitialTab(tab || 'login')
                    setShowAuth(true)
                    if (tab === 'register') window.history.replaceState(null, '', '/register')
                  ...
                  <Suspense fallback={<PageLoader />}>
                    ...
                    {showAuth ? (
                      ...
                      <>
                        ...
                        {activeTab === 'dashboard' && <Dashboard userId={userId} onNavigate={handleTabChange} globalCurrency={globalCurrency} globalCryptocurrency={globalCryptocurrency} userEmail={userEmail} />}
