            ...
            {displayedCurrencies.length === 0 ? (
              ...
              <>
                ...
                {(activeTab === 'all' || activeTab === 'fiat') && filterCurrencies(fiatCurrencies).length > 0 && (
                  <div className="sticky top-0 z-20 px-4 py-2 bg-slate-100 border-b border-slate-200">
                ...
                {(activeTab === 'all' || activeTab === 'crypto') && filterCurrencies(cryptoCurrencies).length > 0 && (
                  <div className="sticky top-24 z-20 px-4 py-2 bg-slate-100 border-b border-slate-200">
