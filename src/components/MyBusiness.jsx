...
export default function MyBusiness({ userId }) {
  ...
  // Show registration form as main content if no businesses
  if (!showRegistrationForm && businesses.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-2xl mx-auto px-4 py-16">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-light text-slate-900 mb-3 tracking-wide">Register Your First Business</h1>
            <p className="text-slate-600 text-lg max-w-lg mx-auto">
              Complete the official business registration form to get started managing your business through our platform.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-900 mb-2">
                    City of Registration <span className="text-red-500">*</span>
                  </label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
                <div>
                  ...
                  />
                  <p className="text-xs text-slate-500 mt-1">Auto-generated by the system</p>
                </div>
              ...
              <div className="mb-8">
                <label className="block text-sm font-semibold text-slate-900 mb-2">
                  Registration Date (Manila Standard Time)
                </label>
                <input
                  type="date"
          ...
          <div className="mt-8 bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
            <h3 className="font-semibold text-slate-900 mb-2">About Business Registration</h3>
            <ul className="text-sm text-slate-700 space-y-1">
              <li>✓ Your business name will be checked for availability</li>
              <li>✓ TIN and Certificate numbers are automatically generated</li>
              <li>✓ All information is securely stored and encrypted</li>
              <li>✓ You can register multiple businesses under your account</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  // Show regular dashboard if businesses exist
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Registration Form (when editing) */}
        {showRegistrationForm && (
          <div className="bg-white rounded-lg border border-slate-200 p-8 mb-8">
            <h3 className="text-2xl font-semibold text-slate-900 mb-6">Register New Business</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="text" value={formData.tin} readOnly className="w-full px-4 py-2 border border-slate-200 rounded-lg bg-slate-50 text-slate-600 cursor-not-allowed font-mono" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-slate-900 mb-2">Certificate Number</label>
                <input type="text" value={formData.certificateOfIncorporation} readOnly className="w-full px-4 py-2 border border-slate-200 rounded-lg bg-slate-50 text-slate-600 cursor-not-allowed font-mono" />
              </div>
                  ...
                  {showCityDropdown && (
                    <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-slate-300 rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto">
                      {searchCities(citySearch).length > 0 ? (
                        ...
                        <div className="px-4 py-2 text-sm text-slate-500 text-center">No cities found</div>
                      )}
                    </div>
                  )}
                </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-900 mb-2">Registration Date</label>
                <input
                  type="date"
                  value={formData.registrationDate}
                  onChange={(e) => setFormData({ ...formData, registrationDate: e.target.value })}
            ...
            <div className="mt-6 flex gap-3">
              <button
                onClick={handleAddBusiness}
                disabled={!formData.businessName || !formData.cityOfRegistration || !businessNameAvailability?.available}
                className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-slate-300 disabled:cursor-not-allowed font-medium"
              >
                Save Business
              </button>
              <button
