...
export default function CharactersPanel({ userId, currentCharacter, onSelectCharacter }) {
  ...
  return (
    <div className="absolute right-4 top-20 w-[380px] max-h-[70vh] overflow-y-auto bg-slate-900 border border-slate-700 rounded-lg p-4 z-40">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button onClick={() => onSelectCharacter(c)} className="px-2 py-1 bg-emerald-600 hover:bg-emerald-700 rounded text-xs text-white">Select</button>
