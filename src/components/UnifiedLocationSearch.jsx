        ...
        <div className="space-y-4">
            ...
            {destinationSearch && searchResults.length === 0 && !loading && (
              <div className="location-search-no-results">
                ...
                <p>No locations found matching "{destinationSearch}"</p>
                <p>Try searching for specific addresses or place types like "church", "restaurant", "hospital", "school", etc.</p>
              </div>
            )}
            ...
            {selectedDestination && (
              <div className="location-confirmation">
                ...
                <p>{selectedDestination.address || 'Destination Selected'}</p>
                <button
