                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            {projectSuppliers.map(sup => (
                              <div key={sup.id} className="p-4 border border-slate-200 rounded-lg hover:border-slate-300 bg-white">
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            {projectPartners.map(partner => (
                              <div key={partner.id} className="p-4 border border-slate-200 rounded-lg hover:border-slate-300 bg-white">
                                <div className="flex justify-between items-start mb-3">
                                  <div>
