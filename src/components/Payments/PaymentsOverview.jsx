...
export default function PaymentsOverview({ merchant, userId, globalCurrency }) {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {!merchant && (
        <div className="bg-white border border-slate-300 rounded-lg p-6 mb-4">
          <h3 className="font-semibold text-slate-900 mb-2">Welcome to Payments</h3>
          <p className="text-slate-700 mb-4">Select or create a merchant account to access merchant-specific features and analytics.</p>
        </div>
      )}
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white border border-slate-300 rounded-lg p-4">
            <p className="text-xs font-semibold text-slate-600 uppercase mb-1">Filtered Transactions</p>
