...
export default function LocationModal({
  ...
  const headerIcon = locationType === 'pickup' ? '📍' : '🎯'
  ...
  return (
    <ExpandableModal
      ...
      badgeContent={selectedLocation ? '✓ Selected' : null}
      showBadge={!!selectedLocation}
    >
      {/* Tab Navigation */}
      <div className="flex border-b border-slate-200 bg-slate-50 overflow-x-auto -mx-4 sm:-mx-6 mb-6 px-4 sm:px-6">
        <button
