  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'partnership', label: '🤝 Join Partnership Network', auth: false },
        { id: 'commitments', label: '🥥 My Partnerships', auth: true }
      ]
    },
    {
      id: 'personal',
              ...
              <div className="p-6 space-y-4">
                ...
                {userBusinesses.map(business => (
                  <button
                    key={business.id}
                    onClick={() => {
                      // Store the section in sessionStorage for later use
                      try {
                        sessionStorage.setItem('pendingBusinessSection', selectedBusinessSection)
                      } catch (e) {
