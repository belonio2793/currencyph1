      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative mb-8">
          <button
            ...
            className="absolute -top-7 right-0 flex items-center gap-2 cursor-pointer transition-colors"
            title="Click to customize quick access cards"
          >
            <span className="text-sm font-medium text-slate-600">Quick Access</span>
            <div className="p-1.5 hover:bg-slate-100 rounded-lg transition-colors text-slate-600 hover:text-slate-800">
