            ...
            <div>
              {enabledCards && enabledCards.length > 0 ? (
                ...
                <div className="text-xs text-slate-500 italic p-3 bg-slate-50 rounded">
                  No cards enabled. Click the settings icon to customize your Quick Access.
                </div>
              )}
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              {verificationStatus ? (
                ...
                <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
                  ...
                  <p className="text-xs text-slate-500">Verify your identity to build trust with lenders in the P2P marketplace</p>
                </div>
              )}
      ...
      {showCustomizeModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-6">
              <p className="text-sm text-slate-600 mb-4">Enable/disable cards and drag to reorder:</p>
