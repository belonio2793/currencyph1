  ...
  return (
    <>
      <div className="bg-gradient-to-br from-amber-50 to-white rounded-xl p-8 border-2 border-amber-300 shadow-lg">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              {isOnline ? (
                ...
                '📡 Offline Mode - Explore the form & preview your commitment'
              )}
            </p>
          </div>
          {!isOnline && (
            <div className="px-4 py-2 bg-orange-100 text-orange-800 rounded-full text-xs font-semibold">
              🔌 Offline
            </div>
          )}
        </div>
        ...
        {!isOnline ? (
          // Offline mode: Show the full form as demo
          <form onSubmit={handleSubmit} className="space-y-6 opacity-85">
            {success && (
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-blue-700 text-sm whitespace-pre-wrap">
                {success}
              </div>
            )}
            ...
            <div className="p-4 bg-amber-100 border border-amber-300 rounded-lg">
              <p className="text-sm font-semibold text-amber-900">
                🌐 You're browsing offline. Explore this form to preview your commitment. When you're back online, sign in to save it to the ecosystem.
              </p>
            </div>
            ...
            >
              Preview Commitment (Demo Mode)
            </button>
          </form>
        ) : !session ? (
          <form onSubmit={handleSubmit} className="space-y-6 opacity-90">
            {error && (
            ...
            <div className="p-4 bg-blue-50 border border-blue-300 rounded-lg">
              <p className="text-sm font-semibold text-blue-900">
                👀 Preview Mode: Fill out this form to preview your commitment. Sign in when ready to save it to the ecosystem.
              </p>
            </div>
            ...
            <button
              type="button"
              onClick={() => onSignInRequired && onSignInRequired()}
