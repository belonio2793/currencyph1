            ...
            <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6">
              ...
              <div className="border-t border-slate-200 pt-4 space-y-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">Transaction Amount</p>
                ...
                {isCryptoCurrency(selectedTransaction.currency_code) && getCryptoInUSD(selectedTransaction.amount, selectedTransaction.currency_code) && (
                  <div className="bg-slate-50 rounded-lg p-4">
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">USD Value</p>
                ...
                {/* Original Amount for Conversions */}
                  ...
                  <div className="bg-slate-50 rounded-lg p-4">
                    ...
                    {selectedTransaction.exchange_rate && (
                      <p className="text-sm text-slate-600 mt-2">
                        Rate: 1 {selectedTransaction.original_currency?.toUpperCase()} = {formatFullPrecision(selectedTransaction.exchange_rate)} {selectedTransaction.currency_code?.toUpperCase()}
                      </p>
                    )}
                  </div>
                )}
                ...
                {/* Received Amount */}
                {selectedTransaction.received_amount && selectedTransaction.received_currency && (
                  <div className="bg-slate-50 rounded-lg p-4">
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">Received Amount</p>
                    <p className="text-xl font-light text-slate-900">
                ...
                {/* Conversion Fees */}
                {selectedTransaction.conversion_fee && (
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">Conversion Fee</p>
                    <p className="text-lg font-light text-slate-900">
                      ...
                      {formatFullPrecision(selectedTransaction.conversion_fee)} {selectedTransaction.conversion_fee_currency?.toUpperCase()}
                    </p>
                  </div>
                )}
              </div>
