...
export default function PokerPage({ userId, userEmail, onShowAuth }) {
  ...
  // Keep header visible when modals open - modals should be displayed over header
  // Removed: useEffect that hid navbar when chip modal opened
  // Headers are now always visible for better UX
  ...
  const isSeatedAt = (tableId) => seats?.some(s => s.table_id === tableId && s.user_id === userId)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div ref={pageRef} className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 min-h-screen flex-1">
          ...
          {/* Table Visualization */}
          <div ref={tableViewRef} className="lg:col-span-2 bg-slate-800 rounded-xl border border-slate-700 p-8 flex flex-col">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-700 rounded-lg p-4 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-slate-300 mt-1">Stakes: {selectedTable.stake_min}/{selectedTable.stake_max}</div>
