...
export class WorldIsometric {
  ...
  destroy() {
    this.stop()
    try { if (this.renderer && this.renderer.domElement) this.renderer.domElement.removeEventListener('click', this._onClick) } catch(e) {}
    try { if (this.resizeObserver) this.resizeObserver.disconnect() } catch(e) {}
    try { if (this.renderer && this.renderer.domElement) this.container.removeChild(this.renderer.domElement) } catch(e) {}
